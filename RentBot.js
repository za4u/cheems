...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6283165737014@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6283165737014@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
item2.EMAIL;type=INTERNET:test@gmail.com\n
item2.X-ABLabel:Email\n
item3.URL:https://whatsapp.com\n
...
"businessOwnerJid": `6283165737014@s.whatsapp.net`
}
}, options)
